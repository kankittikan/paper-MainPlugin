...
public class MapManager implements Listener {
     ...
     */
    public void init() {
        Bukkit.getServer().getPluginManager().registerEvents(this, MainPlugin.getPlugin(MainPlugin.class));
        loadImages();
    }
    ...
    class CustomFile {
        ...
        private final MainPlugin plugin = MainPlugin.getPlugin(MainPlugin.class);
