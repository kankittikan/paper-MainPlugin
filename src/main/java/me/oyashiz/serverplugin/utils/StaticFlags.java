...
public class StaticFlags {
    ...
    public static boolean SurvivalUnBreak = true;
    public static int FukieCantDrop = 0;

    public static int performingLevel = 0;
    ...
    public static boolean canChangeMode = false;
}
